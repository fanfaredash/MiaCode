...
首个正式公开版本，基于 0.5.2 预发布线整理发布。

### 发布

- 将应用版本从 `0.5.2-beta5` 提升为正式版 `1.0.0`，并移除 beta 预发布后缀。
- Windows 发布包命名更新为 `MiaCode-v1.0.0-win64.zip`。
- 通过本地发布脚本打包 `MiaCode-v1.0.0-win64.zip`，SHA256 为 `276ADE65E6DE92D0AA962301ECB2876CFF58D0A5541FB867CBAFB765BD0FC76C`。
