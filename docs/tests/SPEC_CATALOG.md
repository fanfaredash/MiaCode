...
| `src/tools/qml_ui/PreviewTransportPushSpec.cpp` | `preview_transport_push_spec` | `src/app/qml_ui` | `qml-ui.preview-transport-push` | qml_ui | source-contract | normal | all | ctest | active |
| `src/tools/qml_ui/QmlAnalysisModelSpec.cpp` | `qml_analysis_model_spec` | `src/app/qml_ui` | `qml-ui.qml-analysis-model` | qml_ui | behavior | normal | all | ctest | active |
| `src/tools/qml_ui/QmlAppBackgroundModelSpec.cpp` | `qml_app_background_model_spec` | `src/app/qml_ui` | `qml-ui.qml-app-background-model` | qml_ui | behavior | normal | all | ctest | active |
| `src/tools/qml_ui/QmlChartDropBridgeSpec.cpp` | `qml_chart_drop_bridge_spec` | `src/app/qml_ui` | `qml-ui.qml-chart-drop-bridge` | qml_ui | integration | normal | all | ctest | active |
| `src/tools/qml_ui/QmlCoverExportContractSpec.cpp` | `qml_cover_export_contract_spec` | `src/app/qml_ui` | `qml-ui.qml-cover-export-contract` | qml_ui | source-contract | normal | all | ctest | active |
| `src/tools/qml_ui/QmlDocumentLifecycleContractSpec.cpp` | `qml_document_lifecycle_contract_spec` | `src/app/qml_ui` | `qml-ui.qml-document-lifecycle-contract` | qml_ui | source-contract | normal | all | ctest | active |
| `src/tools/qml_ui/QmlDocumentProjectionSpec.cpp` | `qml_document_projection_spec` | `src/app/qml_ui` | `qml-ui.qml-document-projection` | qml_ui | behavior | normal | all | ctest | active |
| `src/tools/qml_ui/QmlDocumentReplacementSequenceSpec.cpp` | `qml_document_replacement_sequence_spec` | `src/app/qml_ui` | `qml-ui.qml-document-replacement-sequence` | qml_ui | integration | normal | all | ctest | active |
| `src/tools/qml_ui/QmlEditorControllerSpec.cpp` | `qml_editor_controller_spec` | `src/app/qml_ui` | `qml-ui.qml-editor-controller` | qml_ui | integration | normal | all | ctest | active |
| `src/tools/qml_ui/QmlExportFontContractSpec.cpp` | `qml_export_font_contract_spec` | `src/app/qml_ui` | `qml-ui.qml-export-font-contract` | qml_ui | source-contract | normal | all | ctest | active |
...
| `src/tools/qml_ui/QmlUiThemeContractSpec.cpp` | `qml_ui_theme_contract_spec` | `src/app/qml_ui` | `qml-ui.qml-ui-theme-contract` | qml_ui | source-contract | normal | all | ctest | active |
| `src/tools/qml_ui/TimelineSurfaceReadySpec.cpp` | `timeline_surface_ready_spec` | `src/app/qml_ui` | `qml-ui.timeline-surface-ready` | qml_ui | source-contract | normal | all | ctest | active |
| `src/tools/qml_ui/V1ShellRemovalSpec.cpp` | `v1_shell_removal_spec` | `src/app/qml_ui` | `qml-ui.v1-shell-removal` | qml_ui | source-contract | normal | all | ctest | active |
...
| `src/tools/v2/AnalysisServiceSpec.cpp` | `analysis_service_spec` | `src/app/v2` | `v2.analysis-service` | v2 | integration | high | all | ctest | active |
| `src/tools/v2/ApplicationServicesSpec.cpp` | `application_services_spec` | `src/app/v2` | `v2.application-services` | v2 | integration | high | all | ctest | active |
| `src/tools/v2/ChartMediaServiceSpec.cpp` | `chart_media_service_spec` | `src/app/v2` | `v2.chart-media-service` | v2 | behavior | high | all | ctest | active |
| `src/tools/v2/ChartWorkspaceFileServiceSpec.cpp` | `chart_workspace_file_service_spec` | `src/app/v2` | `v2.chart-workspace-file-service` | v2 | behavior | high | all | ctest | active |
| `src/tools/v2/ChartWorkspaceSpec.cpp` | `chart_workspace_spec` | `src/app/v2` | `v2.chart-workspace` | v2 | behavior | high | all | ctest | active |
| `src/tools/v2/DocumentPortSpec.cpp` | `document_port_spec` | `src/app/v2` | `v2.document-port` | v2 | boundary | high | all | ctest | active |
| `src/tools/v2/EditorPageRouterSpec.cpp` | `editor_page_router_spec` | `src/app/v2` | `v2.editor-page-router` | v2 | integration | high | all | ctest | active |
| `src/tools/v2/EditorSyncControllerSpec.cpp` | `editor_sync_controller_spec` | `src/app/v2` | `v2.editor-sync-controller` | v2 | integration | high | all | ctest | active |
| `src/tools/v2/ExportEngineSpec.cpp` | `export_engine_spec` | `src/app/v2` | `v2.export-engine` | v2 | integration | high | all | ctest | active |
| `src/tools/v2/JobProgressServiceSpec.cpp` | `job_progress_service_spec` | `src/app/v2` | `v2.job-progress-service` | v2 | behavior | high | all | ctest | active |
| `src/tools/v2/PlaybackCoordinatorConstructionSpec.cpp` | `playback_coordinator_construction_spec` | `src/app/runtime` | `v2.playback-coordinator-construction` | v2 | boundary | high | all | compile-only | blocked-link |
| `src/tools/v2/PlaybackCoordinatorSpec.cpp` | `playback_coordinator_spec` | `src/app/runtime` | `v2.playback-coordinator` | v2 | source-contract | high | all | ctest | active |
| `src/tools/v2/PlaybackStateAuthoritySpec.cpp` | `playback_state_authority_spec` | `src/app/v2` | `v2.playback-state-authority` | v2 | behavior | high | all | ctest | active |
| `src/tools/v2/PlaybackStorageBoundarySpec.cpp` | `playback_storage_boundary_spec` | `src/app/runtime` | `v2.playback-storage-boundary` | v2 | boundary | high | all | ctest | active |
| `src/tools/v2/PreferencesPortSpec.cpp` | `preferences_port_spec` | `src/app/v2` | `v2.preferences-port` | v2 | boundary | high | all | ctest | active |
| `src/tools/v2/PreviewAppearanceStateSpec.cpp` | `preview_appearance_state_spec` | `src/app/v2` | `v2.preview-appearance-state` | v2 | behavior | high | all | ctest | active |
| `src/tools/v2/PreviewHostSpec.cpp` | `preview_host_spec` | `src/app/runtime` | `v2.preview-host` | v2 | source-contract | high | all | ctest | active |
| `src/tools/v2/PreviewPortSpec.cpp` | `preview_port_spec` | `src/app/v2` | `v2.preview-port` | v2 | boundary | high | all | ctest | active |
| `src/tools/v2/RuntimeContextBoundarySpec.cpp` | `runtime_context_boundary_spec` | `src/app/runtime` | `v2.runtime-context-boundary` | v2 | boundary | high | all | ctest | active |
| `src/tools/v2/TimelineHostSpec.cpp` | `timeline_host_spec` | `src/app/runtime` | `v2.timeline-host` | v2 | behavior | high | all | ctest | active |
| `src/tools/v2/UiRequestServiceSpec.cpp` | `ui_request_service_spec` | `src/app/v2` | `v2.ui-request-service` | v2 | behavior | high | all | ctest | active |
| `src/tools/v2/ValidationPortSpec.cpp` | `validation_port_spec` | `src/app/v2` | `v2.validation-port` | v2 | boundary | high | all | ctest | active |
