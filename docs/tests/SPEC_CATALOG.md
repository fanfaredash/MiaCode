...
| `src/tools/ui/ComicResourceModelContractSpec.cpp` | `comic_resource_model_contract_spec` | `src/app/ui` | `qml-ui.comic-resource-model-contract` | ui | source-contract | normal | all | ctest | active |
