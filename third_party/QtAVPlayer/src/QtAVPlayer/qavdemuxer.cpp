...
#ifndef QT_AVPLAYER_NO_AVDEVICE  // MiaCode: avdevice dropped (capture-device only) to trim package size
...
#endif
#ifndef QT_AVPLAYER_NO_AVDEVICE  // MiaCode: avdevice dropped to trim package size (no capture devices used)
