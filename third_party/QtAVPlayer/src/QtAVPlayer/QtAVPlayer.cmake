...
# MiaCode: avdevice is capture-device-only and unused for file playback; it is
# dropped to trim package size (set QT_AVPLAYER_NO_AVDEVICE before including this).
if(NOT QT_AVPLAYER_NO_AVDEVICE)
...
if(NOT QT_AVPLAYER_NO_AVDEVICE)
    list(APPEND QtAVPlayer_LIBS ${AVDEVICE_LIBRARY})
endif()
...
if(QT_AVPLAYER_VA_DRM)
    ...
    find_path(DRM_FOURCC_H_PATH drm_fourcc.h
        HINTS ${MIACODE_VAAPI_INCLUDE_DIRS}
    ...
    if (DRM_FOURCC_H_PATH)
        ...
        message(STATUS "Using ${DRM_FOURCC_H_PATH}/drm_fourcc.h")
