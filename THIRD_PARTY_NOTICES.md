...
| BASS, BASSmix, BASS_FX, BASS_AAC, BASSOPUS | Windows, macOS, and Linux audio backends, offline export mixing, and waveform decoding; packaged DLL/dylib/so runtimes | Kept for non-commercial MiaCode builds/releases. BASS is not a general open-source dependency; do not use MiaCode's bundled BASS files for commercial redistribution without appropriate BASS licensing. |
