...
- Realtime preview BGM timing is backend-owned: Windows, macOS, and Linux use BASS/BASS_FX for all
  rates; builds without BASS use the stretched SoundTouch path with an engine-time anchor clock.
