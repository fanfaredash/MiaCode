...
bool isSupportedPermission(const QString& permission)
{
    static const QSet<QString> allowed{
        ...
        QStringLiteral("open.timeline"),
        QStringLiteral("open.preview"),
        QStringLiteral("open.validation"),
        QStringLiteral("open.analysis"),
        QStringLiteral("open.export"),
        QStringLiteral("open.ui"),
        QStringLiteral("open.extensions"),
