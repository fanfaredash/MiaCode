...
QVector<QJsonObject> extensionApiRegistry()
{
    static const QVector<QJsonObject> registry{
        ...
        apiDescriptor(QStringLiteral("preview.setJudgeEffectsEnabled"), QStringLiteral("preview/setJudgeEffectsEnabled"), QStringLiteral("preview.control"), QStringLiteral("medium"), QStringLiteral("implemented"), QStringLiteral("Show or hide preview judge-hit effects.")),
