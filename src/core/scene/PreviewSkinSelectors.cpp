...
const QImage* selectTapNoteGuideImage(const PreviewSkinAssets& skin, const TimelineNoteMarker& marker, bool useMineSkin)
{
    ...
    if (useMineSkin && isMine && !skin.noteGuideMineImage.isNull()) {
...
const QImage* selectHoldEndNoteGuideImage(const PreviewSkinAssets& skin, const TimelineNoteMarker& marker, bool useMineSkin)
{
    if (useMineSkin && marker.isMine && !skin.noteGuideHoldMineEndImage.isNull()) {
...
const QImage* selectTapImage(const PreviewSkinAssets& skin, const TimelineNoteMarker& marker, bool useMineSkin)
{
    ...
    if (useMineSkin && isMine && !skin.tapMineImage.isNull()) {
...
const QImage* selectHoldImage(const PreviewSkinAssets& skin, const TimelineNoteMarker& marker, bool useMineSkin)
{
    if (useMineSkin && marker.isMine && !skin.holdMineImage.isNull()) {
...
const QImage* selectSlideStarImage(const PreviewSkinAssets& skin, const TimelineNoteMarker& marker, bool useMineSkin)
{
    const bool slideLike = marker.type == QLatin1String("slide") || marker.type == QLatin1String("wifi");
    ...
    if (useMineSkin && isMine && !skin.starMineImage.isNull()) {
...
const QImage* selectSlideMovingStarImage(const PreviewSkinAssets& skin, const TimelineNoteMarker& marker, bool useMineSkin)
{
    if (useMineSkin && marker.trackMine && !skin.starMineImage.isNull()) {
        return &skin.starMineImage;
    }
    const QImage* starImage = &skin.starImage;
...
const QImage* selectSlideTrackImage(const PreviewSkinAssets& skin, const TimelineNoteMarker& marker, bool useMineSkin)
{
    if (useMineSkin && marker.trackMine && !skin.slideTrackMineImage.isNull()) {
...
const QImage* selectWifiTrackImage(const PreviewSkinAssets& skin, const TimelineNoteMarker& marker, int sampleIndex, int sampleCount, bool useMineSkin)
{
    const QVector<QImage>* images = &skin.wifiImages;
    if (useMineSkin && marker.trackMine && !skin.wifiMineImages.isEmpty()) {
