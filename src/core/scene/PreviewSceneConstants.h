...
inline constexpr qreal kHoldTargetWidth = static_cast<qreal>(miacode::preview_skin::kDefaultHoldTargetWidth);
...
inline constexpr qreal kTouchPadDistanceA = kLogicalCanvasSize * 400.0 / 1080.0;
inline constexpr qreal kTouchPadDistanceB = kTouchPadDistanceA * 2.2 / 4.0;
inline constexpr qreal kTouchPadDistanceD = kTouchPadDistanceA * 4.1 / 4.0;
inline constexpr qreal kTouchPadDistanceE = kTouchPadDistanceA * 3.1 / 4.0;
inline constexpr qreal kTouchPadHitRadiusLogical = 38.0;
inline constexpr qreal kTouchPadCenterHitRadiusLogical = 58.0;
...
inline constexpr qreal kSlideTrackScale = static_cast<qreal>(miacode::preview_skin::kSlideTrackScale);
...
inline constexpr int kPreviewSmallCollectionReserve = 16;
...
inline constexpr qreal kObjectWaitStateStartOpacity = 0.5;
inline constexpr qreal kObjectWaitStateOpacityDelta = 0.5;
