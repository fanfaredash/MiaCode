void MiniaudioPreviewAudioBackend::startBackgroundTrack(double second)
{
...
void MiniaudioPreviewAudioBackend::seekBackgroundTrack(double second)
{
    if (!hasBackgroundTrack()) {
        return;
    }
...
void MiniaudioPreviewAudioBackend::pauseBackgroundTrack()
{
    if (!hasBackgroundTrack()) {
        return;
    }
...
MiniaudioPreviewAudioBackend::PausePreviewResult MiniaudioPreviewAudioBackend::capturePausedPreviewTransaction()
{
    return pausePreviewPlaybackTransaction();
}

MiniaudioPreviewAudioBackend::PausePreviewResult MiniaudioPreviewAudioBackend::pausePreviewPlaybackTransaction()
{
...
double MiniaudioPreviewAudioBackend::backgroundPlaybackSecond() const
{
    if (!hasBackgroundTrack()) {
        return 0.0;
    }
...
void MiniaudioPreviewAudioBackend::syncBackgroundTrack(double timelineSecond)
{
    if (!hasBackgroundTrack()) {
        return;
    }
...
double MiniaudioPreviewAudioBackend::syncPreviewPlaybackClockTransaction(double fallbackSecond)
{
...
double MiniaudioPreviewAudioBackend::resumeRetainedPreviewPlaybackTransaction()
{
...
double MiniaudioPreviewAudioBackend::seekRetainedPreviewPlaybackTransaction(double targetSecond, bool continuePlaying)
{
...
void MiniaudioPreviewAudioBackend::resetRetainedPreviewPlaybackTransaction(double targetSecond)
{
    retainedPlayback_.second = seekRetainedPreviewPlaybackTransaction(targetSecond, false);
}

void MiniaudioPreviewAudioBackend::clearRetainedPreviewPlaybackTransaction()
{
    retainedPlayback_.mode = RetainedPlaybackMode::None;
}

MiniaudioPreviewAudioBackend::RetainedPlaybackMode MiniaudioPreviewAudioBackend::retainedPlaybackMode() const
{
    return retainedPlayback_.mode;
}

MiniaudioPreviewAudioBackend::RetainedBgmState MiniaudioPreviewAudioBackend::retainedBgmState() const
{
    return retainedPlayback_.bgmState;
}

double MiniaudioPreviewAudioBackend::authoritativePlaybackSecond() const
{
    if (hasBackgroundTrack()) {
...
bool MiniaudioPreviewAudioBackend::audition(const QString& kind, double gain)
{
    lastNativeErrorCode_ = 0;
    return playKindInternal(kind, gain, &lastNativeErrorCode_);
}

void MiniaudioPreviewAudioBackend::stopAll()
{
