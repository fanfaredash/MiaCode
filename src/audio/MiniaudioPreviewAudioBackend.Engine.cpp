bool MiniaudioPreviewAudioBackend::initializeAudioEngine()
{
    MC_OP("MiniaudioPreviewAudioBackend::initializeAudioEngine");
...
void MiniaudioPreviewAudioBackend::initializeAssets()
{
    MC_OP("MiniaudioPreviewAudioBackend::initializeAssets");
...
void MiniaudioPreviewAudioBackend::initializeBackgroundTrack()
{
...
void MiniaudioPreviewAudioBackend::armBackgroundTrackClock(double timelineSecond)
{
    if (engineState_ == nullptr) {
        return;
    }
...
void MiniaudioPreviewAudioBackend::clearBackgroundTrackClockAnchor()
{
...
void MiniaudioPreviewAudioBackend::applyVolumes()
{
...
bool MiniaudioPreviewAudioBackend::prepareStretchedBackgroundTrack(double timelineSecond)
{
    ...
    if (stretchedBackgroundState_ != nullptr
        ...
        && qAbs(stretchedBackgroundState_->playbackRate - playbackSession_.backgroundTrackPlaybackRate)
            <= kMiniaudioPreviewSfxEpsilonSeconds) {
        return true;
    }
...
double MiniaudioPreviewAudioBackend::stretchedBackgroundPlaybackSecond() const
{
    if (stretchedBackgroundState_ == nullptr || !stretchedBackgroundState_->soundInitialized) {
...
bool MiniaudioPreviewAudioBackend::stretchedBackgroundClockReady() const
{
    if (stretchedBackgroundState_ == nullptr || !stretchedBackgroundState_->soundInitialized) {
        return false;
    }
