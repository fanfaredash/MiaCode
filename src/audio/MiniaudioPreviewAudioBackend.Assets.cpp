QString MiniaudioPreviewAudioBackend::resolveTrackPath(const QString& chartPath) const
{
...
QString MiniaudioPreviewAudioBackend::resolveSfxDir() const
{
...
void MiniaudioPreviewAudioBackend::resetBackgroundTrack()
{
...
void MiniaudioPreviewAudioBackend::resetStretchedBackgroundTrack()
{
...
void MiniaudioPreviewAudioBackend::resetBanks()
{
