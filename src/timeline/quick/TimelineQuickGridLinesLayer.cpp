    ...
    QQuickWindow* window) const
{
    ...
    // Playback follow produces a fractional scroll value every presented frame. Grid,
    // waveform and notes must consume that same value or their relative positions oscillate.
