...
{
    const QString menu = readSource(QStringLiteral("src/app/ui/chrome/MainMenu.qml"));
    const QString item = readSource(QStringLiteral("src/app/ui/components/AppMenuItem.qml"));
    const QString commands = readSource(QStringLiteral("src/app/ui/document/ChartTransformCommands.h"));
