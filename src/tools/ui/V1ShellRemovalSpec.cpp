...
int main(int argc, char** argv)
{
    ...
    // 消费 PreviewModel / TimelineModel / ShellLifecycle。
    ...
    const QString mainQml = readSource(QStringLiteral("src/app/ui/Main.qml"));
    const QString splitViewQml = readSource(QStringLiteral("src/app/ui/layout/MainSplitView.qml"));
