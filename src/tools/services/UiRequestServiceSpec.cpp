...
miacode::FileRequest sampleRequest()
{
...
{
    miacode::UiRequestService service;
    QSignalSpy notices(&service, &miacode::UiRequestService::noticeRequested);

    service.postNotice(miacode::NoticeSeverity::Error,
                       QStringLiteral("Export"),
                       QStringLiteral("Launch failed"),
                       QStringLiteral("ffmpeg missing"));
    service.postNotice(miacode::NoticeSeverity::Information, QStringLiteral("Export"),
                       QStringLiteral("Done"));
    service.postNotice(miacode::NoticeSeverity::Warning, QStringLiteral("Export"),
...
bool verifyActionableNotices(QTextStream& err)
{
    ...
    const QString second = service.requestNoticeAction(
        miacode::NoticeSeverity::Error, QStringLiteral("t"), QStringLiteral("x"),
...
{
    miacode::UiRequestService service;
    QSignalSpy requests(&service, &miacode::UiRequestService::choiceRequested);
