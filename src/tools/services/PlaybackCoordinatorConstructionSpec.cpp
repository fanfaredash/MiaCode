...
class FakePreferences final : public miacode::PlaybackPreferencesPort
{
public:
...
class FakeValidation final : public miacode::PlaybackValidationPort
{
public:
...
class FakeDocuments final : public miacode::PlaybackDocumentPort
{
public:
...
class FakePreview final : public miacode::PlaybackPreviewPort
{
public:
