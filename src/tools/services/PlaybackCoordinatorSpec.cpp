...
bool verifyCoordinatorOwnsOnlyPlaybackContracts(QTextStream& err)
{
    ...
    ok &= require(header.contains(QStringLiteral("class PlaybackCoordinator"))
                      && header.contains(QStringLiteral("miacode::PlaybackControl"))
                      && header.contains(QStringLiteral("miacode::PreviewPlaybackPort"))
                      && header.contains(QStringLiteral("miacode::AudioClockSource")),
    ...
    ok &= require(!header.contains(QStringLiteral("PreviewSurface.h"))
                      ...
                      && !header.contains(QStringLiteral("public miacode::PreviewSurface"))
                      && !header.contains(QStringLiteral("public miacode::TimelineSurface")),
...
bool verifyPlaybackIdentityGateBehavior(QTextStream& err)
{
    ...
    const miacode::PlaybackCallbackStamp initial = gate.currentStamp();
    ...
    const miacode::PlaybackCallbackStamp current = gate.currentStamp();
    ...
    const miacode::PlaybackCallbackStamp wrongRevision{41, 10, 1};
    const miacode::PlaybackCallbackStamp wrongGeneration{42, 9, 1};
    ...
    gate.invalidate();
    const miacode::PlaybackCallbackStamp invalidated = gate.currentStamp();
