...
bool MainWindow::sendPreviewCommand(const QString& mode, int cursorLine, int cursorCol, const QString& trackPath)
{
    ...
    QJsonObject cmd{
        ...
        {"sfx_volume", qMax(qMax(qMax(qMax(qMax(qMax(previewAudioSettings_.answerVolume, previewAudioSettings_.slideVolume), previewAudioSettings_.breakVolume), previewAudioSettings_.exVolume), previewAudioSettings_.touchVolume), previewAudioSettings_.touchholdVolume), previewAudioSettings_.fireworkVolume)},
