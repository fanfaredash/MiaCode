...
class AppBackgroundModel final : public QObject
{
    Q_OBJECT
    ...
    Q_PROPERTY(QVariantList sizeModeOptions READ sizeModeOptions NOTIFY localeLabelsChanged)
    Q_PROPERTY(QVariantList positionOptions READ positionOptions NOTIFY localeLabelsChanged)
...
public:
    ...
    explicit AppBackgroundModel(miacode::UiRequestService* uiRequests = nullptr,
