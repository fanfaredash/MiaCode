...
const QHash<QString, QString>& enMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.skin_settings.chart_effect", "Chart Effect"},
        {"dialog.skin_settings.chart_effect.standard", "Standard"},
...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.skin_settings.chart_effect", "谱面效果"},
        {"dialog.skin_settings.chart_effect.standard", "标准"},
        {"dialog.skin_settings.chart_effect.starry", "DX"},
...
const QHash<QString, QString>& jaMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.skin_settings.chart_effect", "譜面エフェクト"},
        {"dialog.skin_settings.chart_effect.standard", "標準"},
        {"dialog.skin_settings.chart_effect.starry", "DX"},
