...
const QHash<QString, QString>& enMap()
{
    static const QHash<QString, QString> map{
        ...
        {"media_tools.compress_the_background_video_under", "Compress the background video under 20 MB while preserving its frame rate and removing its audio track (the original is backed up)."},
        ...
        {"media_tools.insert_silence_at_the_start", "Insert silence at the start of the current track (MP3/WAV/FLAC/OGG); the original is backed up."},
        ...
        {"media_tools.sample_rate_description", "Convert the current track (MP3/WAV/FLAC/OGG) to 44100 Hz while preserving its format."},
...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"media_tools.compress_the_background_video_under", "保持原帧率、移除音轨，将背景视频压缩到 20 MB 以内，并自动备份原文件。"},
        ...
        {"media_tools.insert_silence_at_the_start", "在当前音频（MP3/WAV/FLAC/OGG）开头插入一段静音，并自动备份原文件。"},
        ...
        {"media_tools.sample_rate_description", "将当前音频（MP3/WAV/FLAC/OGG）转换为 44100Hz，并保持原文件格式。"},
...
const QHash<QString, QString>& jaMap()
{
    static const QHash<QString, QString> map{
        ...
        {"media_tools.compress_the_background_video_under", "元のフレームレートを維持して音声を削除し、背景動画を 20 MB 未満に圧縮します（元ファイルは自動的にバックアップされます）。"},
        ...
        {"media_tools.insert_silence_at_the_start", "現在の音声（MP3/WAV/FLAC/OGG）の先頭に無音を挿入し、元ファイルを自動でバックアップします。"},
        ...
        {"media_tools.sample_rate_description", "現在の音声（MP3/WAV/FLAC/OGG）を、形式を維持したまま 44100Hz に変換します。"},
