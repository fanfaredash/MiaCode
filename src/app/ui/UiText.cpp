...
const QHash<QString, QString>& enMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.preferences.background.overlay", "Masking"},
        {"dialog.preferences.background.overlay_button", "Masking..."},
        {"dialog.preferences.background.overlay_dialog_title", "Background Masking"},
        {"dialog.preferences.background.overlay.toolbar", "Top bar"},
        {"dialog.preferences.background.overlay.status", "Status bar"},
        {"dialog.preferences.background.overlay.panel", "Panel"},
        {"dialog.preferences.background.overlay.card", "Card"},
        {"dialog.preferences.background.overlay.editor_header", "Editor header"},
        {"dialog.preferences.background.overlay.input", "Input"},
...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.preferences.background.overlay", "遮蔽度"},
        {"dialog.preferences.background.overlay_button", "遮蔽度..."},
        {"dialog.preferences.background.overlay_dialog_title", "背景遮蔽度"},
        {"dialog.preferences.background.overlay.toolbar", "顶部栏"},
        {"dialog.preferences.background.overlay.status", "状态栏"},
        {"dialog.preferences.background.overlay.panel", "面板"},
        {"dialog.preferences.background.overlay.card", "卡片"},
        {"dialog.preferences.background.overlay.editor_header", "编辑器头部"},
        {"dialog.preferences.background.overlay.input", "输入框"},
        ...
        {"document.chart_section_every_4_measures", "每4小节"},
...
const QHash<QString, QString>& jaMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.preferences.background.overlay", "遮蔽度"},
        {"dialog.preferences.background.overlay_button", "遮蔽度..."},
        {"dialog.preferences.background.overlay_dialog_title", "背景の遮蔽度"},
        {"dialog.preferences.background.overlay.toolbar", "上部バー"},
        {"dialog.preferences.background.overlay.status", "ステータスバー"},
        {"dialog.preferences.background.overlay.panel", "パネル"},
        {"dialog.preferences.background.overlay.card", "カード"},
        {"dialog.preferences.background.overlay.editor_header", "エディターヘッダー"},
