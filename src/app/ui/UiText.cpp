...
const QHash<QString, QString>& enMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.unsaved_tab_changes.details.metadata", "Save writes the metadata changes; discard restores the metadata page."},
...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.unsaved_tab_changes.details.metadata", "保存写入元数据修改；放弃撤销元数据页中的修改。"},
...
const QHash<QString, QString>& jaMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.unsaved_tab_changes.details.metadata", "保存するとメタデータの変更を書き込み、破棄するとメタデータページを元に戻します。"},
...
const QHash<QString, QPair<QString, QString>>& qmlOnlyEntries()
{
    static const QHash<QString, QPair<QString, QString>> map{
        ...
        {QStringLiteral("保存写入元数据修改；放弃撤销元数据页中的修改。"), {QStringLiteral("Save writes the metadata changes; discard restores the metadata page."), QStringLiteral("保存するとメタデータの変更を書き込み、破棄するとメタデータページを元に戻します。")}},
