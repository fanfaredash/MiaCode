...
const QHash<QString, QString>& enMap()
{
    static const QHash<QString, QString> map{
        ...
        {"drop_chart.open_chart", "Open Chart"},
        {"drop_chart.open_hint", "Release to open this maidata chart"},
        {"drop_chart.invalid_selection", "Choose One Drop Action"},
        {"drop_chart.invalid_selection_hint", "Drop one chart, or audio files only"},
        {"drop_chart.invalid_selection_message", "Drop exactly one maidata.txt (or its folder), or drop only supported audio files."},
        ...
        {"dialog.video_export.output_mode", "Save as type"},
        {"dialog.video_export.output_mode.mp4", "MP4 video"},
        {"dialog.video_export.output_mode.wav", "WAV audio"},
        {"dialog.video_export.output_mode.both", "MP4 + WAV"},
        {"dialog.video_export.output_files_hint.one", "Will create: %1"},
        {"dialog.video_export.output_files_hint.two", "Will create: %1 and %2"},
        {"dialog.video_export.save_filter.mp4", "MP4 Video (*.mp4)"},
        {"dialog.video_export.save_filter.wav", "WAV Audio (*.wav)"},
        {"dialog.video_export.save_filter.both", "MP4 + WAV (same name) (*.mp4)"},
        ...
        {"dialog.batch_export.export_cover", "Export covers"},
        {"dialog.batch_export.no_cover", "Do not export covers"},
        {"dialog.batch_export.cover_result", "Covers: %1 succeeded, %2 failed"},
        {"dialog.batch_export.cover_adjusted", "Adjusted chart frames:"},
        ...
        {"dialog.video_export.progress.finalizing_wav", "Finalizing WAV audio..."},
        ...
        {"export_page.cover_preview_unavailable", "Cover preview unavailable"},
        ...
        {"video_export.output_file", "Output File"},
...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"drop_chart.open_chart", "打开谱面"},
        {"drop_chart.open_hint", "松开鼠标以打开该 maidata 谱面"},
        {"drop_chart.invalid_selection", "请选择一种拖入操作"},
        {"drop_chart.invalid_selection_hint", "请拖入一个谱面，或仅拖入音频文件"},
        {"drop_chart.invalid_selection_message", "请只拖入一个 maidata.txt（或其所在文件夹），或者仅拖入受支持的音频文件。"},
        ...
        {"dialog.video_export.output_mode", "保存类型"},
        {"dialog.video_export.output_mode.mp4", "MP4 视频"},
        {"dialog.video_export.output_mode.wav", "WAV 音频"},
        {"dialog.video_export.output_mode.both", "MP4 + WAV"},
        {"dialog.video_export.output_files_hint.one", "将生成：%1"},
        {"dialog.video_export.output_files_hint.two", "将生成：%1、%2"},
        {"dialog.video_export.save_filter.mp4", "MP4 视频 (*.mp4)"},
        {"dialog.video_export.save_filter.wav", "WAV 音频 (*.wav)"},
        {"dialog.video_export.save_filter.both", "MP4 + WAV（同名） (*.mp4)"},
        ...
        {"dialog.batch_export.export_cover", "批量导出封面"},
        {"dialog.batch_export.no_cover", "不批量导出封面"},
        {"dialog.batch_export.cover_result", "封面：成功 %1，失败 %2"},
        {"dialog.batch_export.cover_adjusted", "谱面帧时间已调整："},
        ...
        {"dialog.video_export.progress.finalizing_wav", "正在整理 WAV 音频..."},
        ...
        {"export_page.cover_preview_unavailable", "当前封面暂不可预览"},
...
const QHash<QString, QString>& jaMap()
{
    static const QHash<QString, QString> map{
        ...
        {"drop_chart.open_chart", "譜面を開く"},
        {"drop_chart.open_hint", "マウスを離すとこの maidata 譜面を開きます"},
        {"drop_chart.invalid_selection", "ドロップ操作を1つ選択してください"},
        {"drop_chart.invalid_selection_hint", "譜面を1つ、または音声ファイルのみをドロップしてください"},
        {"drop_chart.invalid_selection_message", "maidata.txt（またはそのフォルダー）を1つだけ、あるいは対応する音声ファイルだけをドロップしてください。"},
        ...
        {"dialog.video_export.output_mode", "保存形式"},
        {"dialog.video_export.output_mode.mp4", "MP4 動画"},
        {"dialog.video_export.output_mode.wav", "WAV 音声"},
        {"dialog.video_export.output_mode.both", "MP4 + WAV"},
        {"dialog.video_export.output_files_hint.one", "作成されるファイル：%1"},
        {"dialog.video_export.output_files_hint.two", "作成されるファイル：%1、%2"},
        {"dialog.video_export.save_filter.mp4", "MP4 動画 (*.mp4)"},
        {"dialog.video_export.save_filter.wav", "WAV 音声 (*.wav)"},
        {"dialog.video_export.save_filter.both", "MP4 + WAV（同名） (*.mp4)"},
        ...
        {"dialog.batch_export.export_cover", "カバーを一括出力"},
        {"dialog.batch_export.no_cover", "カバーを一括出力しない"},
        {"dialog.batch_export.cover_result", "カバー：成功 %1、失敗 %2"},
        {"dialog.batch_export.cover_adjusted", "譜面フレームの時刻を調整："},
        ...
        {"dialog.video_export.progress.finalizing_wav", "WAV 音声を仕上げ中..."},
        ...
        {"export_page.cover_preview_unavailable", "カバープレビューを表示できません"},
        ...
        {"video_export.output_file", "出力ファイル"},
