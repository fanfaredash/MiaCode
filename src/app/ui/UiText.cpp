...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"action.audio_settings", "音频"},
        {"action.video_settings", "视频"},
        {"toolbar.export", "导出"},
        ...
        {"dialog.preferences.editor_overwrite_mode", "覆写模式"},
        {"dialog.preferences.preserve_difficulty_switch_view", "切换难度时保持代码区位置和预览进度"},
