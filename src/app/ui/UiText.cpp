...
const QHash<QString, QString>& enMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.welcome.chinese_input", "Input methods and character correction"},
        {"dialog.welcome.chinese_input.disable", "Turn off input methods + correct full-width characters"},
        {"dialog.welcome.chinese_input.enable", "Leave unchanged"},
        {"dialog.welcome.chinese_input.fullwidth", "Correct full-width characters only"},
        {"dialog.welcome.chinese_input.hint",
         "Choose character correction on its own, combine it with input-method blocking, "
         "or leave input unchanged."},
        ...
        {"preferences.block_input_methods_and_correct_full_width", "Turn off input methods + correct full-width characters"},
        {"preferences.chinese_input", "IME block"},
        {"preferences.conflicts_with_1", "Conflicts with \"%1\""},
        {"preferences.correct_full_width_only", "Correct full-width characters only"},
        ...
        {"preferences.input_handling", "Input methods and character correction"},
        {"preferences.leave_input_unchanged", "Leave unchanged"},
        {"preferences.off", "Off"},
        {"preferences.on", "On"},
...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.welcome.chinese_input", "输入法与字符更正"},
        {"dialog.welcome.chinese_input.disable", "关闭输入法+全角字符更正"},
        {"dialog.welcome.chinese_input.enable", "不处理"},
        {"dialog.welcome.chinese_input.fullwidth", "仅全角字符更正"},
        {"dialog.welcome.chinese_input.hint",
         "可选择仅更正全角字符、与关闭输入法一起启用，或不处理输入。"},
        ...
        {"preferences.block_input_methods_and_correct_full_width", "关闭输入法+全角字符更正"},
        {"preferences.chinese_input", "输入法禁止"},
        {"preferences.conflicts_with_1", "与「%1」重复"},
        {"preferences.correct_full_width_only", "仅全角字符更正"},
        ...
        {"preferences.input_handling", "输入法与字符更正"},
        {"preferences.leave_input_unchanged", "不处理"},
        {"preferences.off", "关闭"},
        {"preferences.on", "开启"},
...
const QHash<QString, QString>& jaMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.welcome.chinese_input", "入力メソッドと文字の修正"},
        {"dialog.welcome.chinese_input.disable", "入力メソッドをオフ+全角文字を修正"},
        {"dialog.welcome.chinese_input.enable", "処理しない"},
        {"dialog.welcome.chinese_input.fullwidth", "全角文字のみ修正"},
        {"dialog.welcome.chinese_input.hint",
         "全角文字の修正のみ、入力メソッドのブロックとの併用、または無処理を選択できます。"},
        ...
        {"preferences.block_input_methods_and_correct_full_width", "入力メソッドをオフ+全角文字を修正"},
        {"preferences.chinese_input", "IME禁止"},
        {"preferences.conflicts_with_1", "「%1」と重複しています"},
        {"preferences.correct_full_width_only", "全角文字のみ修正"},
        ...
        {"preferences.input_handling", "入力メソッドと文字の修正"},
        {"preferences.leave_input_unchanged", "処理しない"},
        {"preferences.off", "オフ"},
        {"preferences.on", "オン"},
...
const QHash<QString, QPair<QString, QString>>& qmlOnlyEntries()
{
    static const QHash<QString, QPair<QString, QString>> map{
        ...
        {QStringLiteral("%1 ms"), {QStringLiteral("%1 ms"), QStringLiteral("%1 ms")}},
        ...
        {QStringLiteral("手部半径"), {QStringLiteral("Hand radius"), QStringLiteral("手の半径")}},
