...
const QHash<QString, QString>& enMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.preferences.background.enabled", "Enable application background"},
        ...
        {"dialog.preferences.background.size_mode", "Size Mode"},
        {"dialog.preferences.background.position", "Position"},
        {"dialog.preferences.background.images_filter", "Images (*.png *.jpg *.jpeg *.bmp *.webp);;All files (*.*)"},
        {"dialog.preferences.background.size.cover", "Cover"},
        {"dialog.preferences.background.size.contain", "Contain"},
        {"dialog.preferences.background.size.stretch", "Stretch"},
        {"dialog.preferences.background.size.center", "Center"},
        {"dialog.preferences.background.size.repeat", "Repeat"},
...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.preferences.background.enabled", "启用应用背景"},
        ...
        {"dialog.preferences.background.size_mode", "尺寸模式"},
        {"dialog.preferences.background.position", "位置"},
        {"dialog.preferences.background.images_filter", "图片 (*.png *.jpg *.jpeg *.bmp *.webp);;所有文件 (*.*)"},
        {"dialog.preferences.background.size.cover", "覆盖"},
        {"dialog.preferences.background.size.contain", "适应"},
        {"dialog.preferences.background.size.stretch", "拉伸"},
        {"dialog.preferences.background.size.center", "居中原尺寸"},
        {"dialog.preferences.background.size.repeat", "平铺"},
...
const QHash<QString, QString>& jaMap()
{
    static const QHash<QString, QString> map{
        ...
        {"dialog.preferences.preview_side.left", "左"},
        {"dialog.preferences.background_group", "背景"},
        {"dialog.preferences.background.enabled", "アプリ背景を有効化"},
        ...
        {"dialog.preferences.background.size_mode", "サイズ"},
        {"dialog.preferences.background.position", "位置"},
        {"dialog.preferences.background.images_filter", "画像 (*.png *.jpg *.jpeg *.bmp *.webp);;すべてのファイル (*.*)"},
        {"dialog.preferences.background.size.cover", "カバー"},
        {"dialog.preferences.background.size.contain", "収める"},
        {"dialog.preferences.background.size.stretch", "引き伸ばし"},
        {"dialog.preferences.background.size.center", "中央"},
        {"dialog.preferences.background.size.repeat", "タイル"},
