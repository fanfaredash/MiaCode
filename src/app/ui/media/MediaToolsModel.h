...
class MediaToolsModel final : public QObject
{
    Q_OBJECT
...
public:
    explicit MediaToolsModel(                       miacode::UiRequestService& uiRequests,
                               miacode::JobProgressService& jobProgress,
                               miacode::MediaToolsEngine*& engineSlot,
                               QObject* parent = nullptr);
    ~MediaToolsModel() override;
...
private:
    ...
    miacode::MediaToolsEngine** engineSlot_ = nullptr;
    miacode::MediaToolsEngine* engine() const
    {
