...
AppDialog {
    ...
    title: qsTrId("document.designer_management")
    preferredWidth: 460
    ...
    body: ColumnLayout {
        ...
        Repeater {
            ...
            delegate: RowLayout {
                ...
                Label {
                    ...
                    ToolTip.text: qsTrId("document.no_chart_yet_records_des")
                        .arg(slotRow.slotId)
        ...
        AppCheckBox {
            id: unifiedBox
            Layout.fillWidth: true
            text: qsTrId("document.all_difficulties_share_this_designer")
    ...
    AppDialog {
        ...
        title: qsTrId("document.pick_the_canonical_designer")
        preferredWidth: 420
        ...
        body: ColumnLayout {
            ...
            Label {
                Layout.fillWidth: true
                text: qsTrId("document.multiple_distinct_designer_names_were_detected")
            ...
            AppComboBox {
                id: designerChoice
                Layout.fillWidth: true
                model: canonicalPicker.candidates.concat([qsTrId("document.clear_all")])
            }
        }
    }
}
