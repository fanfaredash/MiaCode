#include "editor/EditorInputBridge.h"
...
EditorInputBridge::EditorInputBridge(QObject* parent) : QObject(parent) {}

QObject* EditorInputBridge::target() const { return target_; }
bool EditorInputBridge::imeInputDisabled() const { return imeInputDisabled_; }
QQuickTextDocument* EditorInputBridge::textDocument() const { return textDocument_; }

void EditorInputBridge::setTarget(QObject* target)
{
...
void EditorInputBridge::setImeInputDisabled(bool disabled)
{
...
void EditorInputBridge::setTextDocument(QQuickTextDocument* document)
{
...
void EditorInputBridge::applyInputMethodState()
{
...
QPointF EditorInputBridge::textHitPoint(qreal x, qreal y) const
{
...
bool EditorInputBridge::eventFilter(QObject* watched, QEvent* event)
{
