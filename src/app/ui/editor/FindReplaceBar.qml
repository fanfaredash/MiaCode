    ...
    Item {
        ...
        Item {
            ...
            AppTextField {
                ...
                placeholderText: qsTrId("metadata.find")
                text: root.query
            ...
            AppTextField {
                ...
                width: searchArea.fieldWidth
                placeholderText: qsTrId("metadata.replace")
        ...
        Item {
            ...
            AppButton {
                ...
                width: actionArea.buttonWidth
                text: qsTrId("metadata.replace_all")
                emphasized: true
