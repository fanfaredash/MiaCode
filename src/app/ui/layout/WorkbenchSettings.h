...
// 布局项写入 PreferenceDocument 的 preferences.json（与主题、编辑器同一文件）。
...
class WorkbenchSettings final : public QObject
{
    ...
    Q_PROPERTY(bool previewHidePv READ previewHidePv WRITE setPreviewHidePv NOTIFY previewHidePvChanged)
