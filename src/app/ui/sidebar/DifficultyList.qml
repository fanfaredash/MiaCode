...
Column {
    ...
    Item {
        ...
        Row {
            ...
            IconButton {
                ...
                tooltip: qsTrId("sidebar.add_difficulty")
        ...
        delegate: Column {
            ...
            Repeater {
                ...
                delegate: NavRow {
                    ...
                    // with it.
                    textLeftPadding: 38
                    Accessible.name: qsTrId("qml.1_line_2").arg(modelData.title).arg(modelData.line)
    ...
    ChoiceDialog {
        ...
        title: qsTrId("qml.delete_current_difficulty")
        message: qsTrId("qml.the_current_difficulty_and_its_source_will_be_removed_from_the_d")
        dismissChoiceId: "cancel"
        choices: [
            { id: "cancel", label: qsTrId("action.cancel"), role: "reject" },
            { id: "remove", label: qsTrId("action.ok"), role: "accept" }
        ]
