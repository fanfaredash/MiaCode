...
class CommandService final : public QObject
{
    Q_OBJECT
public:
    CommandService(DocumentModel& document,
    ...
    // editor, not back to the backend — see DocumentModel::transformChartSelection.
