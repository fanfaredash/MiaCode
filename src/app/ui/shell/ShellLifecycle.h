...
class ShellLifecycle final : public QObject
{
    Q_OBJECT

public:
    // No MainWindow: the close question is a page-router operation.
    explicit ShellLifecycle(miacode::EditorPageRouter*& routerSlot,
...
private:
    miacode::EditorPageRouter** routerSlot_ = nullptr;
    miacode::EditorPageRouter* router() const
    {
