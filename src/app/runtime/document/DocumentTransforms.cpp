...
QString miacode::runtime::DocumentSessionHost::resolveInitialOpenDirectory() const
{
...
void miacode::runtime::DocumentSessionHost::setLastOpenDirectory(const QString& pathOrDir)
{
...
QString Session::resolveInitialOpenDirectory() const
{
    return documents_->resolveInitialOpenDirectory();
}

void Session::setLastOpenDirectory(const QString& pathOrDir)
{
    documents_->setLastOpenDirectory(pathOrDir);
}

void Session::onNormalizeWholeChart()
{
