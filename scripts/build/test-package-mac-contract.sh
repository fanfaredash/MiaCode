...
require_text "$PACKAGE_SCRIPT" 'libavcodec.62.dylib'
require_text "$PACKAGE_SCRIPT" 'libavfilter.11.dylib'
require_text "$PACKAGE_SCRIPT" 'libavformat.62.dylib'
require_text "$PACKAGE_SCRIPT" 'libavutil.60.dylib'
require_text "$PACKAGE_SCRIPT" 'libswresample.6.dylib'
require_text "$PACKAGE_SCRIPT" 'libswscale.9.dylib'
...
require_text "$PROVISION_SCRIPT" 'FFMPEG_VERSION="8.1.2"'
