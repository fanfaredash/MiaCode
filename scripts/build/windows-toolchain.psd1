...
@{
    ...
    FFmpeg = @{
        ...
        DevDir = 'third_party\ffmpeg\windows\dev'
    ...
    Bass = @{
        RuntimeDir = 'third_party\bass\bin\win64'
        RuntimeDlls = @('bass.dll', 'bassmix.dll', 'bass_fx.dll', 'bass_aac.dll', 'bassopus.dll')
    }

    Package = @{
        DistNamePattern = 'MiaCode-v{version}-win64'
        ...
        RequiredRelativePaths = @(
            ...
            'app\bass_aac.dll', 'app\bassopus.dll',
