...
- Extension system v1:
  - Files: `src/extensions/ExtensionManifest.*`, `src/extensions/ExtensionHostProcess.*`, `src/extensions/ExtensionManager.*`, `src/app/ui/UiText.*`, `src/app/mainwindow/sections/preferences/MainWindow.PreferencesDialog.cpp`, `resources/extensions/extensionHost.js`, `resources/extensions/README.md`, `docs/specs/extensions/EXTENSION_SYSTEM_V1.md`
  - Classes: `miacode::extensions::ExtensionManager`, `miacode::extensions::ExtensionHostProcess`
  - Owns: local extension discovery, VSCode-like manifest validation, data-only language-pack contributions, Preferences > Extensions enable/disable and refresh UI, user extension folder watching, Tools-menu command contributions, stdio JSON-RPC Extension Host process lifecycle, and the v1 document/message/diagnostics API bridge
- Packaging scripts:
