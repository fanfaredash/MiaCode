...
- Cover export studio:
  - Files: `src/app/qml_ui/export/QmlCoverExportSession.*`, `src/app/qml_ui/export/CoverExportPage.qml`, `src/tools/cover_export/CoverStudioWindow.*`, `CoverStudioPanel.*`, `CoverLayerListPanel.*`, `CoverLayerListModel.*`, `CoverLayoutModel.*`, `CoverCompositionState.*`, `CoverComposerView.*`, `CoverFramePlaybackController.*`, `CoverFrameSceneBinder.*`, `CoverFrameExportPlan.*`, `SceneFrameRenderer.*`, `src/intro/qml/CoverComposer.qml`, `src/app/mainwindow/sections/export/MainWindow.ExportFlow.cpp`
  - Classes: `QmlCoverExportSession`, `CoverFramePlaybackController`, `CoverFrameSceneBinder`, `CoverFrameExportPlan`, `CoverStudioWindow`, `CoverStudioPanel`, `CoverLayerListPanel`, `CoverLayerListModel`, `CoverLayoutModel`, `CoverCompositionState`, `CoverComposerView`, `SceneFrameRenderer`
